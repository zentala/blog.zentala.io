...
thanks to [scale effect](https://en.wikipedia.org/wiki/Economies_of_scale) in mass

* propety managment personel on site for:
  * maintainence and repairs
  * management of rentals for a good return on your investment
* neccesery shops and services, eg. restaurant, catering, gym, etc.
* shared spaces
* lower costs of building infrastructure and cost
  thanks to [scale effect](https://en.wikipedia.org/wiki/Economies_of_scale) in mass
